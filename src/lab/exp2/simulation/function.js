window.view = {
	...
	validateRightangletriangleInputs: function() {
		...
		if ( a !== '2')
			alert('Incorrect value of input variables(arguments). Calculating the area of a right angle triangle requires the height and base of the right angle triangle. Try again.')
		else if ( b !== 'float' )
